const treats = {
  ...
  C1: [{name: 'Whatchamacallits', price: 75}, {name: 'Whatchamacallits', price: 75}, {name: 'Whatchamacallits', price: 75}, {name: 'Whatchamacallits', price: 75}, {name: 'Whatchamacallits', price: 75}],
  C2: [{name: 'Butterfingers', price: 75}, {name: 'Butterfingers', price: 75}, {name: 'Butterfingers', price: 75}, {name: 'Butterfingers', price: 75}, {name: 'Butterfingers', price: 75}],
  ...
  D1: [{name: '3 Muskateers', price: 75}, {name: '3 Muskateers', price: 75}, {name: '3 Muskateers', price: 75}, {name: '3 Muskateers', price: 75}, {name: '3 Muskateers', price: 75}],
  ...
  D4: [{name: 'Oh Henry', price: 75}, {name: 'Oh Henry', price: 75}, {name: 'Oh Henry', price: 75}, {name: 'Oh Henry', price: 75}, {name: 'Oh Henry', price: 75}]
}
